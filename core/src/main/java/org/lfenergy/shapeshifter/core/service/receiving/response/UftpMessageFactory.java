...
package org.lfenergy.shapeshifter.core.service.receiving.response;
...
class UftpMessageFactory {

  private static final ObjectFactory OBJECT_FACTORY = new ObjectFactory();

  private static final Map<Class<? extends PayloadMessageType>, Supplier<PayloadMessageType>> RESPONSE_FACTORY_METHODS = Map.ofEntries(
      ...
      Map.entry(TestMessageResponse.class, OBJECT_FACTORY::createTestMessageResponse)
  );

  public static PayloadMessageType instantiate(Class<? extends PayloadMessageType> responseType) {
