...
import org.lfenergy.shapeshifter.connector.service.handler.testmapping.UftpTestBaseMapping;
import org.lfenergy.shapeshifter.connector.service.handler.testmapping.UftpTestDirectMapping;
import org.lfenergy.shapeshifter.connector.service.handler.testmapping.UftpTestMappingErrorAbstractMessageTypeSecondArgOnMethod;
import org.lfenergy.shapeshifter.connector.service.handler.testmapping.UftpTestMappingErrorDoubleMethodMapping;
import org.lfenergy.shapeshifter.connector.service.handler.testmapping.UftpTestMappingErrorNoMessageTypeSecondArgOnMethod;
import org.lfenergy.shapeshifter.connector.service.handler.testmapping.UftpTestMappingErrorNoneVoidReturnTypeOnMethod;
import org.lfenergy.shapeshifter.connector.service.handler.testmapping.UftpTestMappingErrorNotMatchingTypeSecondArgOnMethod;
import org.lfenergy.shapeshifter.connector.service.handler.testmapping.UftpTestMappingErrorOneArgOnMethod;
import org.lfenergy.shapeshifter.connector.service.handler.testmapping.UftpTestMappingErrorThreeArgsOnMethod;
import org.lfenergy.shapeshifter.connector.service.handler.testmapping.UftpTestMappingErrorWrongFirstArgOnMethod;
import org.lfenergy.shapeshifter.connector.service.handler.testmapping.UftpTestMappingErrorWrongSecondArgOnMethod;
import org.lfenergy.shapeshifter.connector.service.handler.testmapping.UftpTestNoUftpMappings;

class UftpProcessorMappingTest {

  private Object uftpIncomingMappingClass;
  private Object uftpOutgoingMappingClass;

  private UftpHandlerMapping testSubject;
  ...
  void discoverDirectMapping() throws Throwable {
    ...
    testSubject = new UftpHandlerMapping(List.of(uftpIncomingMappingClass), List.of(uftpOutgoingMappingClass));
  ...
  void discoverError_oneArgOnMethod() {
    ...
    assertException(actual,
                    "Method onFlexRequest signature must be \"void onFlexRequest(org.lfenergy.shapeshifter.connector.model.UftpParticipant, org.lfenergy.shapeshifter.api.FlexRequest)\". Found signature: \"public void org.lfenergy.shapeshifter.connector.service.handler.testmapping.UftpTestMappingErrorOneArgOnMethod.onFlexRequest(org.lfenergy.shapeshifter.connector.model.UftpParticipant)\"");
  }
  ...
  void discoverError_threeArgsOnMethod() {
    ...
    assertException(actual,
                    "Method onFlexRequest signature must be \"void onFlexRequest(org.lfenergy.shapeshifter.connector.model.UftpParticipant, org.lfenergy.shapeshifter.api.FlexRequest)\". Found signature: \"public void org.lfenergy.shapeshifter.connector.service.handler.testmapping.UftpTestMappingErrorThreeArgsOnMethod.onFlexRequest(org.lfenergy.shapeshifter.connector.model.UftpParticipant,org.lfenergy.shapeshifter.api.FlexRequest,java.lang.String)\"");
  }
  ...
  void discoverError_wrongFirstArgOnMethod() {
    ...
    assertException(actual,
                    "Method onFlexRequest signature must be \"void onFlexRequest(org.lfenergy.shapeshifter.connector.model.UftpParticipant, org.lfenergy.shapeshifter.api.FlexRequest)\". Found signature: \"public void org.lfenergy.shapeshifter.connector.service.handler.testmapping.UftpTestMappingErrorWrongFirstArgOnMethod.onFlexRequest(java.lang.String,org.lfenergy.shapeshifter.api.FlexRequest)\"");
  }
  ...
  void discoverError_wrongSecondArgOnMethod() {
    ...
    assertException(actual,
                    "Method onFlexRequest signature must be \"void onFlexRequest(org.lfenergy.shapeshifter.connector.model.UftpParticipant, org.lfenergy.shapeshifter.api.FlexRequest)\". Found signature: \"public void org.lfenergy.shapeshifter.connector.service.handler.testmapping.UftpTestMappingErrorWrongSecondArgOnMethod.onFlexRequest(org.lfenergy.shapeshifter.connector.model.UftpParticipant,java.lang.String)\"");
  }
  ...
  void discoverError_notMatchingTypeSecondArgOnMethod() {
    ...
    assertException(actual,
                    "Method onFlexRequest signature must be \"void onFlexRequest(org.lfenergy.shapeshifter.connector.model.UftpParticipant, org.lfenergy.shapeshifter.api.FlexRequest)\". Found signature: \"public void org.lfenergy.shapeshifter.connector.service.handler.testmapping.UftpTestMappingErrorNotMatchingTypeSecondArgOnMethod.onFlexRequest(org.lfenergy.shapeshifter.connector.model.UftpParticipant,org.lfenergy.shapeshifter.api.FlexOrder)\"");
  }
  ...
  void discoverError_noneVoidReturnTypeOnMethod() {
    ...
    assertException(actual,
                    "Method onFlexRequest signature must be \"void onFlexRequest(org.lfenergy.shapeshifter.connector.model.UftpParticipant, org.lfenergy.shapeshifter.api.FlexRequest)\". Found signature: \"public java.lang.String org.lfenergy.shapeshifter.connector.service.handler.testmapping.UftpTestMappingErrorNoneVoidReturnTypeOnMethod.onFlexRequest(org.lfenergy.shapeshifter.connector.model.UftpParticipant,org.lfenergy.shapeshifter.api.FlexRequest)\"");
  }
  ...
  void discoverError_doubleMethodMapping() {
    ...
    assertException(actual,
                    "Method org.lfenergy.shapeshifter.connector.service.handler.testmapping.UftpTestMappingErrorDoubleMethodMapping:onFlexRequestBase is already registered to handle incoming type org.lfenergy.shapeshifter.api.FlexRequest. Found second method: org.lfenergy.shapeshifter.connector.service.handler.testmapping.UftpTestMappingErrorDoubleMethodMapping:onFlexRequestDirect");
  }
}