...
import org.lfenergy.shapeshifter.connector.config.ReceivingConfig;
import org.lfenergy.shapeshifter.connector.config.UftpConnectorConfig;
import org.lfenergy.shapeshifter.connector.config.ValidationConfig;
...
class UftpReceivedMessageServiceTest {
  ...
  private void setValidationsEnabled() {
    given(config.receiving()).willReturn(new ReceivingConfig(new ValidationConfig(true)));
  }

  private void setValidationsDisabled() {
    given(config.receiving()).willReturn(new ReceivingConfig(new ValidationConfig(false)));
  }
