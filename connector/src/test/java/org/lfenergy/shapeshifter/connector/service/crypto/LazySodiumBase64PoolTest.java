...
class LazySodiumBase64PoolTest {
  ...
  @Test
  public void correctTypeIsCreated() throws Exception {
  ...
  @Test
  public void claimedTwice_resultIsDifferentInstances() throws Exception {
    final LazySodiumBase64Pool testSubject = new LazySodiumBase64Pool();
    final LazySodiumJava v1 = testSubject.claim();
  ...
  @Test
  public void claimReleaseClaim_resultBothAreSameInstance() {
    final LazySodiumBase64Pool testSubject = new LazySodiumBase64Pool();
    final LazySodiumJava v1 = testSubject.claim();
