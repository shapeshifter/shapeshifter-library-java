...
public interface UftpOutgoingHandler<T extends PayloadMessageType> {
  ...
  /**
   * Handles the outgoing message either by immediately calling {@link org.lfenergy.shapeshifter.connector.service.sending.UftpSendMessageService} or by queueing the message
