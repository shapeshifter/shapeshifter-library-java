...
/**
 * <p>Java class for AGRPortfolioUpdateResponseType complex type.
 * 
...
@XmlType(name = "AGRPortfolioUpdateResponseType")
public class AGRPortfolioUpdateResponseType
    extends PayloadMessageResponseType
{

    @XmlAttribute(name = "AGRPortfolioUpdateMessageID", required = true)
    ...
    public String getAGRPortfolioUpdateMessageID() {
        return agrPortfolioUpdateMessageID;
    }
    ...
    public void setAGRPortfolioUpdateMessageID(String value) {
        this.agrPortfolioUpdateMessageID = value;
    }
